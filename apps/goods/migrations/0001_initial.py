    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类名code', max_length=30, verbose_name='类名code')),
                ('desc', models.TextField(default='', help_text='类别描述', verbose_name='类别描述')),
                ('category_type', models.IntegerField(choices=[(2, '二级类目'), (3, '三级类目'), (1, '一级类目')], help_text='类目级别', verbose_name='类目级别')),
