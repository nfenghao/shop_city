...
class OrderInfo(models.Model):
    ...
    order_sn = models.CharField(max_length=10, null=True, blank=True, unique=True, verbose_name='订单号')
...
class OrderGoods(models.Model):
    ...
    订单的商品详情
    '''
    # 一个订单对象下,存在多个商品对象,我们已知的外键字段是一种一对多的关系,就是说
    # 在a里面存在一个外键字段为b,那就是说一个b对象包含多个a实例对象,那么就可以使用related_name
    # 取出多个a实例对象
